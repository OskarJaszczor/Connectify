		...
		<div className="mainContainer">
			...
			<div className="channelsContainer">
				<div className="channelHandler">
					<span className="channelChar">#</span>
					<p className="channelName">Super kanal</p>
				</div>
			</div>
				...
				<div className="chat">
					<div className="messageContainer">
						...
						<div className="messageBox">
							...
							<p className="messageContent">To jest swietna wiadomosc</p>
						</div>
					</div>
					<div className="messageContainer">
						<div className="messageAuthorAvatar"></div>
						<div className="messageBox">
							...
							<p className="messageContent">
								To jest swietna wiadomosc To jest swietna wiadomosc To jest swietna wiadomoscTo jest swietna wiadomoscTo
								jest swietna wiadomosc To jest swietna wiadomoscTo jest swietna wiadomoscTo jest swietna wiadomoscTo
								jest swietna wiadomosc To jest swietna wiadomoscTo jest swietna wiadomosc To jest swietna wiadomoscTo
								jest swietna wiadomoscTo jest swietna wiadomoscTo jest swietna wiadomosc
							</p>
						</div>
					</div>
					<div className="messageContainer">
